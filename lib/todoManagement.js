...
function todoListManagement() {
  ...
  function loadTodo(userTodos){
    todos = userTodos.map(
    (todo) => Object.assign(new Todo(), todo) 
    //!!Important!!!! Ensure that the loadTodo method converts these plain objects into proper Todo instances.
    //Object.assign(target, source): return target obj, Properties in the target object are overwritten by properties in the sources if they have the same key. Later sources' properties overwrite earlier ones.
  );
  }
